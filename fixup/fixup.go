...
var enumRefMap = map[string]string{
	...
	"Audits.getEncodedResponse.encoding":                    "Encoding",
	...
	"Debugger.BreakLocation.type":                           "BreakLocationType",
	"Debugger.continueToLocation.targetCallFrames":          "TargetCallFrame",
	"Debugger.paused.reason":                                "Reason",
	"Debugger.Scope.type":                                   "ScopeType",
	"Debugger.setInstrumentationBreakpoint.instrumentation": "Instrumentation",
	"Debugger.setPauseOnExceptions.state":                   "ExceptionsState",
	"Emulation.ScreenOrientation.type":                      "Orientation",
	"Emulation.setEmitTouchEventsForMouse.configuration":    "TouchConfiguration",
	"Emulation.setTouchEmulationEnabled.configuration":      "EnabledConfiguration",
	"Fetch.AuthChallengeResponse.response":                  "Response",
	"Fetch.AuthChallenge.source":                            "Source",
	"HeadlessExperimental.ScreenshotParams.format":          "Format",
	"IndexedDB.KeyPath.type":                                "KeyPathType",
	"IndexedDB.Key.type":                                    "KeyType",
	"Input.dispatchKeyEvent.type":                           "KeyType",
	"Input.dispatchMouseEvent.button":                       "ButtonType",
	"Input.dispatchMouseEvent.pointerType":                  "PointerType",
	...
	"LayerTree.ScrollRect.type":                             "ScrollRectType",
	"Log.LogEntry.level":                                    "Level",
	"Log.LogEntry.source":                                   "Source",
	"Log.ViolationSetting.name":                             "Violation",
	"Network.AuthChallengeResponse.response":                "AuthChallengeResponseType",
	"Network.AuthChallenge.source":                          "AuthChallengeSourceType",
	"Network.Initiator.type":                                "InitiatorType",
	"Network.Request.mixedContentType":                      "MixedContent",
	"Network.Request.referrerPolicy":                        "ReferrerPolicy",
	"Page.captureScreenshot.format":                         "ScreenshotFormat",
	"Page.captureSnapshot.format":                           "SnapshotFormat",
	"Page.printToPDF.transferMode":                          "TransferMode",
	"Page.setDownloadBehavior.behavior":                     "DownloadBehavior",
	"Page.setWebLifecycleState.state":                       "LifecycleState",
	"Page.startScreencast.format":                           "ScreencastFormat",
	"Performance.setTimeDomain.timeDomain":                  "TimeDomain",
	...
	"Page.fileChooserOpened.mode":                           "ChooserMode",
	"Page.handleFileChooser.action":                         "ChooserAction",
}
...
func fixupEnumParameter(typ string, p *pdl.Type, d *pdl.Domain) *pdl.Type {
	...
	ref, ok := enumRefMap[fqname]
	if !ok {
		panic(fmt.Sprintf("undefined type enum name %q", fqname))
	}
